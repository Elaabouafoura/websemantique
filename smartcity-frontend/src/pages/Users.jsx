...
export default function Users() {
  ...
  // ✅ Fonction asynchrone pour charger les utilisateurs
  const load = async () => {
    try {
      setLoading(true);
  ...
  const addUser = async () => {
    try {
      ...
      setForm({ id: "", nom: "", age: "", type_utilisateur: "" });
      load();
    } catch (error) {
  ...
  const fields = [
    { key: "id", label: "ID", type: "text", placeholder: "Entrez l'identifiant unique" },
    { key: "nom", label: "Nom", type: "text", placeholder: "Entrez le nom complet" },
    { key: "age", label: "Âge", type: "number", placeholder: "Entrez l'âge" },
    { key: "type_utilisateur", label: "Type Utilisateur", type: "text", placeholder: "Ex: Admin, Client, etc." }
  ];

  const headers = ["ID", "Nom", "Âge", "Type"];
        ...
        <div style={styles.formCard}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={styles.formActions}>
              ...
              <button 
                type="button"
                onClick={() => setForm({ id: "", nom: "", age: "", type_utilisateur: "" })}
                    ...
                    <tbody>
                      {users.map((user) => (
                        ...
                        >
                          ...
                          <td style={styles.tableCell}>
                            <span style={styles.ageBadge}>{user.age} ans</span>
                          </td>
                          <td style={styles.tableCell}>
                            <span 
                              style={{
